...
describe("this should test if values are invalid", function() {
    it("this should test to see if code value is invalid", function() {
        assert.deepEqual({ status: 'Invalid code' }, courseCost("p3", 24))
    })

    it("this should test to see if day number value is invalid", function() {
